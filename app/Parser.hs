...
match s = mapM matchChar s <|> fail ("Expected " ++ show s)
...
alphanumeric = digit <|> letter <|> fail "Expected an alphanumeric character"

boolean :: Parser Bool
boolean = (match "true" >> return True)
